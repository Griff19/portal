...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['status', 'in', 'range' => [self::STATUS_ACTIVE, self::STATUS_DELETED, self::STATUS_ACTIVATED]],
        ];
    }
     ...
     * @return type
     */
    public static function findBy1cid($_1cid)
    {
        return static::findOne(['1c_id' => $_1cid]);
    }
    /**
